...
from utils_NSS_SINDy_Lib import *
import time
...
# Generate the noise
x_NoiseMag = odeint(Lorenz,x0,np.linspace(0.0,10.0,int(10.0/dt)+1),args=(p0,),rtol = 1e-12, atol = 1e-12)
...
#              'Xi0_List':Xi0}
#iomat.savemat(SavePath+Param_i+"_"+Run_i+"_NSS_SINDy_Lorenz.mat",
#             results)

elaptime = endtime-starttime
FileName = SavePath+"Time_"+Param_i+"_"+Run_i+".dat"
f = open(FileName,"w+")
f.write("%e" % elaptime)
f.close()
