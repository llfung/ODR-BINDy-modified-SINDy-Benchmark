...
# =============================================================================
import sys
DataLength_i = sys.argv[1]
print("DataLength: ", DataLength_i)
#%% Import packages
import numpy as np
...
for i in range(N_run):
    ...
    for j in range(NoiseNum):
        ...
        # Generate the noise
        NoiseMag=NoisePercentageToSwipe[j]*0.01*4.7863
...
iomat.savemat(SavePath+DataLength+"_NSS_SINDy_SwipeNoiseLevel_Rossler.mat",
             results)
